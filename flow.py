...
"""Annotate motion vectors to the movie
Input:
    movie: str
...
def dump_flow(movie, prefix=None, codec="mpeg2", gop=12):
    """Dump motion vectors generated by ffmpeg
    ...
    Input:
        movie: str
            ...
            (Name of the movie have to be same as the directory name)
        prefix: str
            If given, motion vectors are dumped to the directory of this argument
            (Default is same as the argument `movie`)
        codec: str
            The target codec to re-encode the target movie.
            Motion vectors are generated using the codec specified here.
            Currently, (h264 | mpeg4 | mpeg2) is supported.
            (See the 'option' variable in the function to change codec settings.)
        gop: int
            The size of GOP (Default is 12)
    """
    if prefix is None:
        prefix = movie
